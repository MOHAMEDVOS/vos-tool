            ...
            if analyze_button:
                ...
                with tempfile.TemporaryDirectory() as tmpdir:
                    ...
                    with st.spinner(f"Analyzing {len(uploaded_files)} files..."):
                        ...
                        metadata = {"dialer_name": "upload"}
                        df = batch_analyze_folder_fast(
                            str(temp_path),
                            additional_metadata=metadata,
                            show_all_results=not show_flagged_only,
                        )
    ...
    with tab_agent:
        ...
        if audit_mode:
            ...
            if audit_really_running:
                ...
                # Flag is set but no driver exists - clear the stale flag
                ...
                if not agent_name:
                    ...
                    with cancel_col:
                        ...
                        if cancel_agent_audit:
                            ...
                            st.success("Audit cancelled successfully. You can start a new one.")
